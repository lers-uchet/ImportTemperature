...
namespace Lers.Api
{
    ...
    public partial class DownloadsClient 
    {
        ...
        public virtual System.Threading.Tasks.Task<FileResponse> DownloadAsync(string downloadKey, string fileName)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<FileResponse> DownloadAsync(string downloadKey, string fileName, System.Threading.CancellationToken cancellationToken)
        {
            if (downloadKey == null)
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Downloads/{downloadKey}/{fileName}");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 422)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            throw new LersException<ResponseParameters>("BL error", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new LersException("The HTTP status code of the response was not expected (" + status_ + ").", status_, responseData_, headers_, null);
                        }
                    }
                    finally
                    {
    ...
    public partial class EquipmentClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetEquipmentListResponseParameters> GetEquipmentListAsync(System.Collections.Generic.IEnumerable<int> id)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetEquipmentListResponseParameters> GetEquipmentListAsync(System.Collections.Generic.IEnumerable<int> id, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetEquipmentListResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 401)
                        {
                            ...
                            throw new LersException("Unauthorized", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 403)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new LersException("Forbidden", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 422)
                        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetEquipmentResponseParameters> GetEquipmentAsync(int id, bool? getBindings, bool? getReduced)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetEquipmentResponseParameters> GetEquipmentAsync(int id, bool? getBindings, bool? getReduced, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetEquipmentResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Обновляет параметры существующего устройства.
        /// </summary>
        /// <param name="id">Идентификатор изменяемого устройства.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task UpdateEquipmentAsync(int id, System.Collections.Generic.IEnumerable<JsonPatchOperation> body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task UpdateEquipmentAsync(int id, System.Collections.Generic.IEnumerable<JsonPatchOperation> body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    public partial class GenerateClient 
    {
        ...
        /// <summary>
        /// Формирует отчёт, экспортированный в указанном формате.
        /// </summary>
        /// <param name="reportId">Идентификатор формируемого отчёта.</param>
        /// <param name="dataType">Тип данных для формирования отчёта.</param>
        /// <param name="startDate">Начальная дата интервала формирования отчёта.</param>
        /// <param name="endDate">Конечная дата интервала формирования отчёта.</param>
        /// <param name="id">Идентификаторы точек или объектов учёта, для которых формируется отчёт.</param>
        /// <param name="format">Формат, в котором будет сформирован отчёт. По умолчанию Pdf.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DownloadFileResult> GenerateAsync(int reportId, DeviceDataType dataType, System.DateTimeOffset startDate, System.DateTimeOffset endDate, System.Collections.Generic.IEnumerable<int> id, ReportExportFormat? format)
        {
            return GenerateAsync(reportId, dataType, startDate, endDate, id, format, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DownloadFileResult> GenerateAsync(int reportId, DeviceDataType dataType, System.DateTimeOffset startDate, System.DateTimeOffset endDate, System.Collections.Generic.IEnumerable<int> id, ReportExportFormat? format, System.Threading.CancellationToken cancellationToken)
        {
            if (reportId == null)
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Reporting/Generate/ParameterSheet/{reportId}/{dataType}/{startDate}/{endDate}?");
    ...
    public partial class IncidentsClient 
    {
        ...
        /// <summary>
        /// Возвращает активные (открытые) НС для точки учёта.
        /// </summary>
        /// <param name="measurePointId">Идентификатор точки учёта, для которой запрашиваются НС.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Incident>> GetActiveByMeasurePointAsync(int measurePointId)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Incident>> GetActiveByMeasurePointAsync(int measurePointId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Incident>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Возвращает параметры НС и её журнал по уникальному идентификатору.
        /// </summary>
        /// <param name="id">Идентификатор НС, для которой нужно вернуть параметры и журнал.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<IncidentGetResponseParameters> GetByIdAsync(int id)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<IncidentGetResponseParameters> GetByIdAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<IncidentGetResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Создаёт нештатную ситуацию.
        /// </summary>
        /// <param name="body">Параметры запроса.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<BaseSaveResponseParameters> CreateIncidentAsync(CreateIncidentRequestParameters body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<BaseSaveResponseParameters> CreateIncidentAsync(CreateIncidentRequestParameters body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<BaseSaveResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class LoginClient 
    {
        ...
        /// <summary>
        /// Входит в систему с помощью текстового логина и пароля.
        /// </summary>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<LoginResponseParameters> LoginPlainAsync(AuthenticatePlainRequestParameters body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<LoginResponseParameters> LoginPlainAsync(AuthenticatePlainRequestParameters body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<LoginResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Входит в систему с помощью доменной авторизации.
        /// </summary>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<LoginResponseParameters> LoginWindowsAsync(AuthenticateRequestParameters body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<LoginResponseParameters> LoginWindowsAsync(AuthenticateRequestParameters body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<CurrentLoginInfo> GetCurrentLoginV1Async()
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<CurrentLoginInfo> GetCurrentLoginV1Async(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CurrentLoginInfo>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <param name="application">Наименование приложения, которое будет протоколироваться в журналах.</param>
        /// <param name="expiration">Дата, до которой будет действовать токен. Если не указана, будет применён срок жизни из системных параметров.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<LoginResponseParameters> LoginUserAsync(string login, string application, System.DateTimeOffset? expiration)
        {
            return LoginUserAsync(login, application, expiration, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<LoginResponseParameters> LoginUserAsync(string login, string application, System.DateTimeOffset? expiration, System.Threading.CancellationToken cancellationToken)
        {
            if (login == null)
                throw new System.ArgumentNullException("login");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Login/{login}?");
    ...
    public partial class MeasurePointConsumptionClient 
    {
        ...
        /// <summary>
        /// Возвращает потребление по точке учёта за период.
        /// </summary>
        ...
        /// <param name="withSummary">Указывает, что нужно рассчитать суммарные значения.</param>
        /// <param name="considerReportingDate">Указывает, что данные потребления и суммарные значения будут возвращены за период с учетом отчетного часа и отчетного дня. Период данных будет скорректирован.</param>
        /// <param name="units">Типы единиц измерения в которых необходимо вернуть данные по точке учёта.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetMeasurePointConsumptionResponse> GetConsumptionAsync(int id, System.DateTimeOffset start, System.DateTimeOffset end, System.Collections.Generic.IEnumerable<DeviceDataType> dataTypes, ElectricDataKind? electricDataKind, bool? includeCalculated, bool? includeAbsentRecords, bool? withSummary, bool? considerReportingDate, MeasurePointDataUnitsRequestType? units)
        {
            return GetConsumptionAsync(id, start, end, dataTypes, electricDataKind, includeCalculated, includeAbsentRecords, withSummary, considerReportingDate, units, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetMeasurePointConsumptionResponse> GetConsumptionAsync(int id, System.DateTimeOffset start, System.DateTimeOffset end, System.Collections.Generic.IEnumerable<DeviceDataType> dataTypes, ElectricDataKind? electricDataKind, bool? includeCalculated, bool? includeAbsentRecords, bool? withSummary, bool? considerReportingDate, MeasurePointDataUnitsRequestType? units, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            if (withSummary != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("withSummary") + "=").Append(System.Uri.EscapeDataString(ConvertToString(withSummary, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (considerReportingDate != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("considerReportingDate") + "=").Append(System.Uri.EscapeDataString(ConvertToString(considerReportingDate, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (units != null)
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetMeasurePointConsumptionResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Сохраняет показания текущих архивных данных по точке учёта.
        /// </summary>
        /// <param name="id">Идентификатор точки учёта.</param>
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task SetCurrentArchiveAsync(int id, bool? overwriteExisting, ElectricDataKind? electricDataKind, SaveConsumptionRequestParameters body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task SetCurrentArchiveAsync(int id, bool? overwriteExisting, ElectricDataKind? electricDataKind, SaveConsumptionRequestParameters body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    public partial class MeasurePointDataClient 
    {
        ...
        /// <summary>
        /// Сохраняет данные по точке учёта (потребление и интеграторы).
        /// <br/>После сохранения запускается пересчёт данных и диагностика.
        /// </summary>
        /// <param name="id">Идентификатор точки учёта.</param>
        /// <param name="overwriteExisting">Указывает на то, что необходимо перезаписать существующие данные.</param>
        /// <param name="electricDataKind">Вид значений по электроэнергии (исходные/реальные).</param>
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task SaveDataAsync(int id, bool? overwriteExisting, ElectricDataKind? electricDataKind, SaveDataRequestParams body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task SaveDataAsync(int id, bool? overwriteExisting, ElectricDataKind? electricDataKind, SaveDataRequestParams body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
        ...
        /// <summary>
        /// Экспортирует данные за указанный интервал в формате XML80020.
        /// </summary>
        /// <param name="id">Идентификатор точки учёта.</param>
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DownloadTemporaryFileResponseParameters> ExportToXml80020Async(int id, System.DateTimeOffset start, System.DateTimeOffset end, Xml80020ExportOptions body)
        {
            return ExportToXml80020Async(id, start, end, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DownloadTemporaryFileResponseParameters> ExportToXml80020Async(int id, System.DateTimeOffset start, System.DateTimeOffset end, Xml80020ExportOptions body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Data/MeasurePoints/{id}/Export/Xml80020/{start}/{end}");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{start}", System.Uri.EscapeDataString(start.ToString("s", System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{end}", System.Uri.EscapeDataString(end.ToString("s", System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DownloadTemporaryFileResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class MeasurePointDeviceErrorsClient 
    {
        ...
        /// <summary>
        /// Возвращает архив ошибок устройства, связанный с точкой учёта.
        /// </summary>
        /// <param name="id">Идентификатор точки учёта.</param>
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<MeasurePointDeviceErrorsResponseParameters> GetMeasurePointErrorsAsync(int id, System.DateTimeOffset start, System.DateTimeOffset end, System.Collections.Generic.IEnumerable<DeviceDataType> dataTypes)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<MeasurePointDeviceErrorsResponseParameters> GetMeasurePointErrorsAsync(int id, System.DateTimeOffset start, System.DateTimeOffset end, System.Collections.Generic.IEnumerable<DeviceDataType> dataTypes, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<MeasurePointDeviceErrorsResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class MeasurePointLastDataClient 
    {
        ...
        /// </summary>
        /// <param name="mpId">Идентификатор точки учёта, по которой необходимо получить данные.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<MeasurePointLastConsumption> GetMeasurePointLastConsumptionAsync(int mpId)
        {
            return GetMeasurePointLastConsumptionAsync(mpId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<MeasurePointLastConsumption> GetMeasurePointLastConsumptionAsync(int mpId, System.Threading.CancellationToken cancellationToken)
        {
            if (mpId == null)
                throw new System.ArgumentNullException("mpId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Data/MeasurePoints/{mpId}/Consumption/Last");
            urlBuilder_.Replace("{mpId}", System.Uri.EscapeDataString(ConvertToString(mpId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<MeasurePointLastConsumption>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.IDictionary<string, MeasurePointLastConsumption>> GetMeasurePointListLastConsumptionAsync()
        {
            return GetMeasurePointListLastConsumptionAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.IDictionary<string, MeasurePointLastConsumption>> GetMeasurePointListLastConsumptionAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Data/MeasurePoints/Consumption/Last");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.IDictionary<string, MeasurePointLastConsumption>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<MeasurePointLastTotals> GetMeasurePointLastTotalsAsync(int mpId)
        {
            return GetMeasurePointLastTotalsAsync(mpId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<MeasurePointLastTotals> GetMeasurePointLastTotalsAsync(int mpId, System.Threading.CancellationToken cancellationToken)
        {
            if (mpId == null)
                throw new System.ArgumentNullException("mpId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Data/MeasurePoints/{mpId}/Totals/Last");
            urlBuilder_.Replace("{mpId}", System.Uri.EscapeDataString(ConvertToString(mpId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<MeasurePointLastTotals>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.IDictionary<string, MeasurePointLastTotals>> GetMeasurePointListLastTotalsAsync()
        {
            return GetMeasurePointListLastTotalsAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.IDictionary<string, MeasurePointLastTotals>> GetMeasurePointListLastTotalsAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Data/MeasurePoints/Totals/Last");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.IDictionary<string, MeasurePointLastTotals>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class MeasurePointsClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetMeasurePointListResponseParameters> GetMeasurePointsAsync(bool? getEquipment, bool? getAttributes, bool? getCustomers, bool? getLastConsumption, MeasurePointType? type)
        {
            return GetMeasurePointsAsync(getEquipment, getAttributes, getCustomers, getLastConsumption, type, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetMeasurePointListResponseParameters> GetMeasurePointsAsync(bool? getEquipment, bool? getAttributes, bool? getCustomers, bool? getLastConsumption, MeasurePointType? type, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("getLastConsumption") + "=").Append(System.Uri.EscapeDataString(ConvertToString(getLastConsumption, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (type != null)
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetMeasurePointListResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <param name="getCustomer">Указывает, что необходимо получить потребителя точки учёта.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetMeasurePointResponseParameters> GetByIdAsync(int id, bool? getDiagParams, bool? getAutoPollTask, bool? getDevice, bool? getDeviceReduced, bool? getDeviceBinding, bool? getHeatLoss, bool? getSensor, bool? getReports, bool? getCounter, bool? getAttributes, bool? getCustomer)
        {
            return GetByIdAsync(id, getDiagParams, getAutoPollTask, getDevice, getDeviceReduced, getDeviceBinding, getHeatLoss, getSensor, getReports, getCounter, getAttributes, getCustomer, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetMeasurePointResponseParameters> GetByIdAsync(int id, bool? getDiagParams, bool? getAutoPollTask, bool? getDevice, bool? getDeviceReduced, bool? getDeviceBinding, bool? getHeatLoss, bool? getSensor, bool? getReports, bool? getCounter, bool? getAttributes, bool? getCustomer, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetMeasurePointResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class MeasurePointsPollClient 
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public MeasurePointsPollClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings);
        ...
        /// </summary>
        /// <param name="measurePointId">Идентификатор точки учёта, по которой нужно запустить опрос текущих данных.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ManualPollResponseParameters_v1> PollCurrentsV1Async(int measurePointId)
        {
            return PollCurrentsV1Async(measurePointId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ManualPollResponseParameters_v1> PollCurrentsV1Async(int measurePointId, System.Threading.CancellationToken cancellationToken)
        {
            if (measurePointId == null)
                throw new System.ArgumentNullException("measurePointId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Poll/MeasurePoints/{measurePointId}/Currents");
            urlBuilder_.Replace("{measurePointId}", System.Uri.EscapeDataString(ConvertToString(measurePointId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ManualPollResponseParameters_v1>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class MeasurePointTotalsClient 
    {
        ...
        /// <summary>
        /// Возвращает интеграторы по точке учёта за период.
        /// </summary>
        /// <param name="id">Идентификатор точки учёта.</param>
        /// <param name="start">Дата начала периода.</param>
        /// <param name="end">Дата окончания периода.</param>
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetMeasurePointTotalsResponse> GetTotalsAsync(int id, System.DateTimeOffset start, System.DateTimeOffset end, ElectricDataKind? electricDataKind, bool? includeCalculated, bool? includeAbsentRecords, MeasurePointDataUnitsRequestType? units)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetMeasurePointTotalsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task SetTotalsAsync(int id, bool? overwriteExisting, SaveTotalsRequestParameters body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task SetTotalsAsync(int id, bool? overwriteExisting, SaveTotalsRequestParameters body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    public partial class NodeGroupsClient 
    {
        ...
        /// <summary>
        /// Возвращает список доступных пользователю групп объектов учёта.
        /// </summary>
        /// <param name="nodeId">Идентификатор объекта, по которому нужно отфильтровать группы.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NodeGroupWithMembers>> GetNodeGroupsAsync(int? nodeId)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NodeGroupWithMembers>> GetNodeGroupsAsync(int? nodeId, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<NodeGroupWithMembers>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class NodeJobsClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NodeJobDTO>> GetListAsync(bool? incomplete)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NodeJobDTO>> GetListAsync(bool? incomplete, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Core/NodeJobs?");
            if (incomplete != null)
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<NodeJobDTO>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class NodesClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetNodeListResponseParameters> GetNodesAsync(int? nodeGroupId, bool? getMeasurePoints, bool? getServicemen, bool? getServiceCompanies, bool? getSignaling, bool? getCustomers, bool? getSuppliers, bool? getAttributes, NodeType? nodeType)
        {
            return GetNodesAsync(nodeGroupId, getMeasurePoints, getServicemen, getServiceCompanies, getSignaling, getCustomers, getSuppliers, getAttributes, nodeType, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetNodeListResponseParameters> GetNodesAsync(int? nodeGroupId, bool? getMeasurePoints, bool? getServicemen, bool? getServiceCompanies, bool? getSignaling, bool? getCustomers, bool? getSuppliers, bool? getAttributes, NodeType? nodeType, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetNodeListResponseParameters>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Возвращает список общедомовых точек учёта объекта учёта.
        /// </summary>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetMeasurePointListResponseParameters> GetNodeMeasurePointsAsync(int nodeId, bool? getEquipment, bool? getAttributes, bool? getCustomers, bool? getLastConsumption)
        {
            return GetNodeMeasurePointsAsync(nodeId, getEquipment, getAttributes, getCustomers, getLastConsumption, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetMeasurePointListResponseParameters> GetNodeMeasurePointsAsync(int nodeId, bool? getEquipment, bool? getAttributes, bool? getCustomers, bool? getLastConsumption, System.Threading.CancellationToken cancellationToken)
        {
            if (nodeId == null)
                throw new System.ArgumentNullException("nodeId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Core/Nodes/{nodeId}/MeasurePoints?");
        ...
        /// <summary>
        /// Возвращает список квартирных точек объекта учёта.
        /// </summary>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetMeasurePointListResponseParameters> GetNodeCommunalMeasurePointsAsync(int houseId, bool? getEquipment, bool? getAttributes, bool? getCustomers, bool? getLastConsumption)
        {
            return GetNodeCommunalMeasurePointsAsync(houseId, getEquipment, getAttributes, getCustomers, getLastConsumption, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetMeasurePointListResponseParameters> GetNodeCommunalMeasurePointsAsync(int houseId, bool? getEquipment, bool? getAttributes, bool? getCustomers, bool? getLastConsumption, System.Threading.CancellationToken cancellationToken)
        {
            if (houseId == null)
                throw new System.ArgumentNullException("houseId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/Core/Nodes/{houseId}/MeasurePoints/Communal?");
    ...
    public partial class ServerInfoClient 
    {
        ...
        /// <summary>
        /// Возвращает версию сервера ЛЭРС УЧЁТ.
        /// </summary>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ServerInfo> GetVersionAsync()
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ServerInfo> GetVersionAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ServerInfo>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Возвращает дополнительную информацию для вошедшего пользователя.
        /// </summary>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<LoginExtraInfo> GetExtraInfoAsync()
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<LoginExtraInfo> GetExtraInfoAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<LoginExtraInfo>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class TerritoriesClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Territory>> GetListAsync()
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Territory>> GetListAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Territory>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Возвращает территорию по уникальному идентификатору.
        /// </summary>
        /// <param name="id">Идентификатор запрошенной территории.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Territory> GetByIdAsync(int id)
        {
            return GetByIdAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Territory> GetByIdAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Territory>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class WeatherClient 
    {
        ...
        /// <summary>
        /// Возвращает среднесуточные температуры для указанной территории.
        /// </summary>
        /// <param name="id">Идентификатор территории.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TerritoryOutdoorTemperature>> GetAsync(int id)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TerritoryOutdoorTemperature>> GetAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<TerritoryOutdoorTemperature>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new LersException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Сохраняет среднесуточные температуры по территории.
        /// </summary>
        /// <param name="id">Идентификатор территории.</param>
        /// <param name="body">Устанавливаемые значения.</param>
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task SetAsync(int id, System.Collections.Generic.IEnumerable<TerritoryOutdoorTemperature> body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="LersException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task SetAsync(int id, System.Collections.Generic.IEnumerable<TerritoryOutdoorTemperature> body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    public partial class Account
    {
        ...
        /// <summary>
        /// Определяет режим проверки доступа к точке учета.
        /// </summary>
        ...
        /// <summary>
        /// Максимальное количество одновременных сеансов работы под учетной записью.
        /// <br/>При превышении этого количество каждый новый сеанс автоматически закрывает самый старый сеанс.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("smsEMail", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dataStartDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? DataStartDate { get; set; }

        /// <summary>
        /// Режим использования списка IP-адресов, связанных с учетной записью.
        /// <br/>true - разрешен вход только с IP-адресов, указанных в списке;
        /// <br/>false - разрешен вход с любых IP-адресов, кроме указанных в списке;
        /// </summary>
        ...
        /// <summary>
        /// Режимы аутентификации, разрешённые для учётной записи.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор безопасности учётной записи Windows,
        /// <br/>которая сопоставлена с этой учётной записью ЛЭРС УЧЁТ.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("passwordDoesNotExpire", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("loginNotAllowedUntil", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? LoginNotAllowedUntil { get; set; }

        /// <summary>
        /// Время последней неудачной попытки входа.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lastLoginTryDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? LastLoginTryDate { get; set; }

        /// <summary>
        /// Параметры расчёта состояния точек учёта.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("stateParametrs", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// Идентификатор учётной записи в системе безопасности.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор домена учётной записи.
        /// </summary>
    ...
    public partial class AccountGroup
    {
        ...
        /// <summary>
        /// Указывает что для группы учётных записей разрешены все мнемосхемы.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("allowAllDiagrams", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool AllowAllDiagrams { get; set; }

        /// <summary>
        /// Указывает что для группы учётных записей разрешены все отчёты.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("allowAllReports", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool AllowAllReports { get; set; }
    ...
    public partial class AccountIpAddress
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("startIP", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string StartIP { get; set; }

        /// <summary>
        /// Конечный IP-адрес диапазона.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("endIP", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string EndIP { get; set; }

        /// <summary>
        /// Префикс (для проверки по подсети).
        /// </summary>
        ...
        /// <summary>
        /// Длина префикса (для проверки по подсети).
        /// </summary>
        [Newtonsoft.Json.JsonProperty("prefixLength", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class AccountStateParameters
    {
        /// <summary>
        /// Отмечает, что фильтрация типов НС включена.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("isSet", Required = Newtonsoft.Json.Required.Always)]
        public bool IsSet { get; set; }

        /// <summary>
        /// Типы НС, которые учитываются при расчёте состояния.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("incidentTypes", Required = Newtonsoft.Json.Required.Always, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.Generic.ICollection<IncidentType> IncidentTypes { get; set; } = new System.Collections.ObjectModel.Collection<IncidentType>();
    ...
    {
        /// <summary>
        /// Уникальный идентификатор модели адаптера.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int Id { get; set; }

        /// <summary>
        /// Идентификатор модели оборудования, к которой относится адаптер.
        /// </summary>
        ...
        /// <summary>
        /// Флаг, определяющий, нужно ли задавать адрес для адаптера.
        /// </summary>
    ...
    /// <summary>
    /// Запрос аутентификации на сервере по логину и паролю.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class AuthenticatePlainRequestParameters
    {
        ...
        /// <summary>
        /// Название приложения, через которое клиент входит на сервер.
        /// </summary>
    ...
    /// <summary>
    /// Параметры постановки точки учёта на резервный опрос.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class BackupPollSettings
    {
        /// <summary>
        /// Указывает что резервный опрос активен.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("enabled", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool Enabled { get; set; }

        /// <summary>
        /// Идентификатор подключения для резервного опроса.
        /// </summary>
        ...
        /// <summary>
        /// Время начала резервного опроса (в минутах с начала суток).
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("runOnAutoPollAttemptsEnded", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        /// <summary>
        /// Идентификатор созданной или обновлённой записи.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int Id { get; set; }
        ...
        /// <summary>
        /// Версия записи после редактирования в БД.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("editVersion", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class Cell
    {
        ...
        /// <summary>
        /// Маска типов данных, которые возможно снять с устройства.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор модели оборудования, к которой относится ячейка.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipmentModelId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int EquipmentModelId { get; set; }
        ...
        /// Код драйвера.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("driverCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string DriverCode { get; set; }

    }

    /// <summary>
    /// Тип данных хранящихся в ячейке.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Определяет поддерживаемые типы каналов связи.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Маска поддерживаемых скоростей обмена через COM-порт.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Атрибуты записи с потреблением.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Рассчитанные суммарные значения.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class ConsumptionSummaryResponse
    {
        /// <summary>
        /// Месячные суммарные значения.
        /// </summary>
        ...
        public System.Collections.Generic.IDictionary<string, MeasurePointDataConsumptionRecord> Month { get; set; }

        /// <summary>
        /// Суточные суммарные значения.
        /// </summary>
        ...
        public System.Collections.Generic.IDictionary<string, MeasurePointDataConsumptionRecord> Day { get; set; }

        /// <summary>
        /// Суммарные значения для всей таблицы.
        /// </summary>
        ...
        public MeasurePointDataConsumptionRecord Footer { get; set; }

    }

    /// <summary>
    /// Возможности коммуникационного контроллера.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Параметры создания нештатной ситуации.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class CreateIncidentRequestParameters
    {
        ...
        /// <summary>
        /// Дата начала НС. Если отсутствует, за дату начала будет принята текущая дата сервера.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("startDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? StartDate { get; set; }

        /// <summary>
        /// Описание возникшей НС.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор объекта, с которым связана НС.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор точки учёта, с которой связана НС.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор устройства, с которым связана НС.
        /// </summary>
    ...
    {
        /// <summary>
        /// Параметры текущей учётной записи.
        /// </summary>
        ...
        /// <summary>
        /// Действующие разрешения для текущей учетной записи.
        /// <br/>Этот массив сериализуется как строка, чтобы старый клиент мог подключиться к новому серверу.
        /// <br/>Если оставить это поле в виде перечисления, новое значение на сервере не сможет быть десериализовано
        /// <br/>на клиенте, и подключение закончится ошибкой.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("permissions", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> Permissions { get; set; }

        /// <summary>
        /// Группы учетных записей, в которые входит текущая учетная запись.
        /// </summary>
    ...
    public partial class Customer
    {
        ...
        /// <summary>
        /// ИНН.
        /// <br/>В англоязычном мире - VAT (value added tax) identification number.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("executiveName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ExecutiveName { get; set; }

        /// <summary>
        /// Должность руководителя.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("executivePosition", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ExecutivePosition { get; set; }

    }

    /// <summary>
    /// Определяет количество бит данных при обмене через COM-порт.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Порядок следования байт данных.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum DataByteOrder
    {

        [System.Runtime.Serialization.EnumMember(Value = @"LoFirst")]
        LoFirst = 0,

        [System.Runtime.Serialization.EnumMember(Value = @"HiFirst")]
        HiFirst = 1,

    }

    /// <summary>
    /// Возможности цифрового интерфейса.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public enum DataParameter
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"CalorificValue")]
        CalorificValue = 99,

        [System.Runtime.Serialization.EnumMember(Value = @"Humidity")]
        Humidity = 100,

        [System.Runtime.Serialization.EnumMember(Value = @"AtmospherePressure")]
        AtmospherePressure = 101,

        [System.Runtime.Serialization.EnumMember(Value = @"CarbonDioxideContent")]
        CarbonDioxideContent = 102,

        [System.Runtime.Serialization.EnumMember(Value = @"NitrogenContent")]
        NitrogenContent = 103,

        [System.Runtime.Serialization.EnumMember(Value = @"V_NoCount")]
        V_NoCount = 104,

        [System.Runtime.Serialization.EnumMember(Value = @"DensityStd")]
        DensityStd = 105,

        [System.Runtime.Serialization.EnumMember(Value = @"TempOverrunDuration")]
        TempOverrunDuration = 106,

        [System.Runtime.Serialization.EnumMember(Value = @"TempUnderrunDuration")]
        TempUnderrunDuration = 107,

        [System.Runtime.Serialization.EnumMember(Value = @"PressOverrunDuration")]
        PressOverrunDuration = 108,

        [System.Runtime.Serialization.EnumMember(Value = @"PressUnderrunDuration")]
        PressUnderrunDuration = 109,

        [System.Runtime.Serialization.EnumMember(Value = @"FlowUnderrunThresholdDuration")]
        FlowUnderrunThresholdDuration = 110,

        [System.Runtime.Serialization.EnumMember(Value = @"UnacceptablePhysicalStateDuration")]
        UnacceptablePhysicalStateDuration = 111,

    }

    /// <summary>
    /// Категория параметра данных.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public partial class DataParameterValue
    {
        ...
        /// <summary>
        /// Флаг интерполированного значения
        /// </summary>
    ...
    /// <summary>
    /// Разделитель дробной части числовых значений.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public partial class DeviceAddressObject
    {
        ...
        /// <summary>
        /// Идентификатор оборудования, для которого привязан адрес.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipmentId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? EquipmentId { get; set; }
        ...
        /// <summary>
        /// Глубина архива.
        /// <br/>Пока используется только для часовых и месячных привязок устройства ТЭКОН-19, во всех остальных случаях имеет значение 0.
        /// </summary>
        ...
        /// <summary>
        /// Модуль оборудования, для которого привязан адрес. 
        /// <br/>При выборке данных для опроса нужен ещё идентификатор модели оборудования.
        /// </summary>
    ...
    /// <summary>
    /// Привязка ячейки устройства к измеряемому параметру.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class DeviceCellObject
    {
        ...
        /// <summary>
        /// Идентификатор оборудования, к которому привязана ячейка.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipmentId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? EquipmentId { get; set; }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("transformationExpression", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        /// <summary>
        /// Идентификатор оборудования, к которому привязан канал.
        /// </summary>
        ...
        /// <summary>
        /// Номер теплового ввода. 0 - тепловой ввод не используется.
        /// </summary>
        ...
        /// <summary>
        /// Подающая магистраль или обратная.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("measurePointTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class DeviceConfigParam
    {
        ...
        /// <summary>
        /// Описание системного параметра
        /// </summary>
        [Newtonsoft.Json.JsonProperty("generalParamType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public GeneralDeviceConfigParam? GeneralParamType { get; set; }

        /// <summary>
        /// Номер теплового ввода, к которому относится параметр
        /// </summary>
        ...
        /// <summary>
        /// Номер канала, к которому относится параметр
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор модели оборудования, к которой относятся параметры базы настроек.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipmentModelId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int EquipmentModelId { get; set; }

        /// <summary>
        /// Адрес, откуда должен считываться параметр.
        /// </summary>
        ...
        /// <summary>
        /// Код драйвера, по которому сохраняется параметр.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("driverCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string DriverCode { get; set; }
    ...
    public enum DeviceEventArchiveType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"Currents")]
        Currents = 71,

        [System.Runtime.Serialization.EnumMember(Value = @"DataCorrection")]
        DataCorrection = 72,

        [System.Runtime.Serialization.EnumMember(Value = @"ExternalInfluences")]
        ExternalInfluences = 73,

        [System.Runtime.Serialization.EnumMember(Value = @"CommunicationEvents")]
        CommunicationEvents = 74,

        [System.Runtime.Serialization.EnumMember(Value = @"TimeCorrection")]
        TimeCorrection = 75,

        [System.Runtime.Serialization.EnumMember(Value = @"AccessControl")]
        AccessControl = 76,

        [System.Runtime.Serialization.EnumMember(Value = @"SelfDiagnosis")]
        SelfDiagnosis = 77,

        [System.Runtime.Serialization.EnumMember(Value = @"TangentExcess")]
        TangentExcess = 78,

        [System.Runtime.Serialization.EnumMember(Value = @"DiscreteInputsOutputsStates")]
        DiscreteInputsOutputsStates = 79,

        [System.Runtime.Serialization.EnumMember(Value = @"LoadRelayInterlock")]
        LoadRelayInterlock = 80,

        [System.Runtime.Serialization.EnumMember(Value = @"Thresholds")]
        Thresholds = 81,

        [System.Runtime.Serialization.EnumMember(Value = @"LoadControl")]
        LoadControl = 82,

        [System.Runtime.Serialization.EnumMember(Value = @"CurrentUnbalance")]
        CurrentUnbalance = 83,

    }

    /// <summary>
    /// Тип записи архива событий (ошибок) устройства.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum DeviceEventImportance
    {
    ...
    public enum DeviceFeature
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"AdvancedCellBinding")]
        AdvancedCellBinding = 24,

        [System.Runtime.Serialization.EnumMember(Value = @"CellTransformationExpressionSupport")]
        CellTransformationExpressionSupport = 25,
    ...
    public enum DeviceModel
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"EclComfort300")]
        EclComfort300 = 53,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"Ce2727A")]
        Ce2727A = 119,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"Vte1P140M234")]
        Vte1P140M234 = 218,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"MasterFlow")]
        MasterFlow = 257,
        ...
        PulsarHeatMeterUltrasonicV2 = 328,
        ...
        PulsarHeatMeterV8 = 358,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarWaterMeterV1_1")]
        PulsarWaterMeterV1_1 = 359,

        [System.Runtime.Serialization.EnumMember(Value = @"Spe542")]
        Spe542 = 360,
        ...
        PulsarHeatMeterUltrasonicV42 = 365,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"MirS04")]
        MirS04 = 375,
        ...
        PulsarHeatMeterUltrasonicV31 = 379,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"Tem104M")]
        Tem104M = 383,

        [System.Runtime.Serialization.EnumMember(Value = @"Tv7M")]
        Tv7M = 384,

        [System.Runtime.Serialization.EnumMember(Value = @"Metran910_104K")]
        Metran910_104K = 385,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarHeatMeterV15")]
        PulsarHeatMeterV15 = 386,

        [System.Runtime.Serialization.EnumMember(Value = @"SanextCombi")]
        SanextCombi = 387,

        [System.Runtime.Serialization.EnumMember(Value = @"Vte1P140M236")]
        Vte1P140M236 = 388,

        [System.Runtime.Serialization.EnumMember(Value = @"Psc3Ta03")]
        Psc3Ta03 = 389,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarElectronicWaterMeterV1")]
        PulsarElectronicWaterMeterV1 = 390,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarPulseMeter3KV1")]
        PulsarPulseMeter3KV1 = 391,

        [System.Runtime.Serialization.EnumMember(Value = @"Psc4Tm05Mkt")]
        Psc4Tm05Mkt = 392,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarHeatMeterUltrasonicV37")]
        PulsarHeatMeterUltrasonicV37 = 393,

        [System.Runtime.Serialization.EnumMember(Value = @"Psc4Tm05Mnt")]
        Psc4Tm05Mnt = 394,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarElectricMeter1F4TV1")]
        PulsarElectricMeter1F4TV1 = 395,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarElectricMeter3F4TV1")]
        PulsarElectricMeter3F4TV1 = 396,

        [System.Runtime.Serialization.EnumMember(Value = @"Seb1Tm03T")]
        Seb1Tm03T = 397,

        [System.Runtime.Serialization.EnumMember(Value = @"Set4Tm03Mt")]
        Set4Tm03Mt = 398,

        [System.Runtime.Serialization.EnumMember(Value = @"Te3000")]
        Te3000 = 399,

        [System.Runtime.Serialization.EnumMember(Value = @"Flowsic500Cis")]
        Flowsic500Cis = 400,

        [System.Runtime.Serialization.EnumMember(Value = @"IrvisUltra")]
        IrvisUltra = 401,

        [System.Runtime.Serialization.EnumMember(Value = @"Pol424XxStd")]
        Pol424XxStd = 402,

        [System.Runtime.Serialization.EnumMember(Value = @"Sur97")]
        Sur97 = 403,

        [System.Runtime.Serialization.EnumMember(Value = @"MirS03")]
        MirS03 = 404,

        [System.Runtime.Serialization.EnumMember(Value = @"Dymetic5102_1")]
        Dymetic5102_1 = 405,

        [System.Runtime.Serialization.EnumMember(Value = @"Gefest")]
        Gefest = 406,

        [System.Runtime.Serialization.EnumMember(Value = @"StkChronosMeter")]
        StkChronosMeter = 407,

        [System.Runtime.Serialization.EnumMember(Value = @"EchoR03_1")]
        EchoR03_1 = 408,

        [System.Runtime.Serialization.EnumMember(Value = @"Flowgaz")]
        Flowgaz = 409,

        [System.Runtime.Serialization.EnumMember(Value = @"ProfixxxMx")]
        ProfixxxMx = 410,

        [System.Runtime.Serialization.EnumMember(Value = @"Ultramag")]
        Ultramag = 411,

        [System.Runtime.Serialization.EnumMember(Value = @"TurboFlowUfg_F")]
        TurboFlowUfg_F = 412,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarHeatMeterUltrasonicV44")]
        PulsarHeatMeterUltrasonicV44 = 413,

        [System.Runtime.Serialization.EnumMember(Value = @"Um31Rtu")]
        Um31Rtu = 414,

        [System.Runtime.Serialization.EnumMember(Value = @"Protei")]
        Protei = 415,

        [System.Runtime.Serialization.EnumMember(Value = @"MirS05")]
        MirS05 = 416,

        [System.Runtime.Serialization.EnumMember(Value = @"Flowsic500")]
        Flowsic500 = 417,

        [System.Runtime.Serialization.EnumMember(Value = @"Ts11_2_4")]
        Ts11_2_4 = 418,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarHeatMeterUltrasonicV45")]
        PulsarHeatMeterUltrasonicV45 = 419,

        [System.Runtime.Serialization.EnumMember(Value = @"KaratCompact2_223")]
        KaratCompact2_223 = 420,

        [System.Runtime.Serialization.EnumMember(Value = @"LersMsT")]
        LersMsT = 421,

        [System.Runtime.Serialization.EnumMember(Value = @"MirS07")]
        MirS07 = 422,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarHeatMeterCHUltrasonicV46")]
        PulsarHeatMeterCHUltrasonicV46 = 423,

        [System.Runtime.Serialization.EnumMember(Value = @"LersHeatImitator")]
        LersHeatImitator = 424,

        [System.Runtime.Serialization.EnumMember(Value = @"LersSi4Rs232_485")]
        LersSi4Rs232_485 = 425,

        [System.Runtime.Serialization.EnumMember(Value = @"SanextMonoCu")]
        SanextMonoCu = 426,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarIot")]
        PulsarIot = 427,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarHeatMeterUltrasonicV46")]
        PulsarHeatMeterUltrasonicV46 = 428,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarIotWaterMeterModuleV1")]
        PulsarIotWaterMeterModuleV1 = 429,

        [System.Runtime.Serialization.EnumMember(Value = @"QalcometE1")]
        QalcometE1 = 430,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarIotElectronicWaterMeterV1")]
        PulsarIotElectronicWaterMeterV1 = 431,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarIotPulseMeter2KV1")]
        PulsarIotPulseMeter2KV1 = 432,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarIotPulseMeter3KV1")]
        PulsarIotPulseMeter3KV1 = 433,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarIotCompactHeatMeterV1")]
        PulsarIotCompactHeatMeterV1 = 434,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarIotUrtV2_2")]
        PulsarIotUrtV2_2 = 435,

        [System.Runtime.Serialization.EnumMember(Value = @"Tsv2")]
        Tsv2 = 436,

        [System.Runtime.Serialization.EnumMember(Value = @"ErLiteM")]
        ErLiteM = 437,

        [System.Runtime.Serialization.EnumMember(Value = @"Rbp")]
        Rbp = 438,

        [System.Runtime.Serialization.EnumMember(Value = @"UniversalModbus")]
        UniversalModbus = 439,

        [System.Runtime.Serialization.EnumMember(Value = @"Aksioma3")]
        Aksioma3 = 440,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarWaterMeterUltrasonic")]
        PulsarWaterMeterUltrasonic = 441,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarUniversalDevice")]
        PulsarUniversalDevice = 442,

        [System.Runtime.Serialization.EnumMember(Value = @"PulsarWaterMeterV1_20")]
        PulsarWaterMeterV1_20 = 443,

        [System.Runtime.Serialization.EnumMember(Value = @"Sk")]
        Sk = 444,

        [System.Runtime.Serialization.EnumMember(Value = @"Pramer710Pcu")]
        Pramer710Pcu = 445,

        [System.Runtime.Serialization.EnumMember(Value = @"LersSi4Nb")]
        LersSi4Nb = 446,

        [System.Runtime.Serialization.EnumMember(Value = @"LersArt")]
        LersArt = 447,

        [System.Runtime.Serialization.EnumMember(Value = @"LersArd")]
        LersArd = 448,

        [System.Runtime.Serialization.EnumMember(Value = @"QalcosonicE3")]
        QalcosonicE3 = 449,

        [System.Runtime.Serialization.EnumMember(Value = @"Mirtek32Ru")]
        Mirtek32Ru = 450,

        [System.Runtime.Serialization.EnumMember(Value = @"Ursv311")]
        Ursv311 = 451,
    ...
    /// <summary>
    /// Параметры диагностики нештатной ситуации.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class DiagParam
    {
        ...
        /// <summary>
        /// Разрешена ли диагностика данного типа нештатных ситуаций.
        /// </summary>
        ...
        /// <summary>
        /// Количество записей, по которым выполняется диагностика.
        /// </summary>
        ...
        /// Маска типов данных, которые возможно снять с устройства.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("diagDataTypes", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
    ...
    /// <summary>
    /// Ответ на запрос, который формирует файл для загрузки.
    /// <br/>Используется в открытом REST API.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Ответ с ссылкой на загрузку временного файла.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class DownloadTemporaryFileResponseParameters
    {
        ...
        /// <summary>
        /// Ключ для загрузки файла.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("downloadKey", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// <summary>
    /// Параметры управления нагрузкой электросчётчика.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Интервал осреднения профиля мощности.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Параметры уведомления об изменения сущности.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class EntityChangedNotifyParameters
    {
        ...
        /// <summary>
        /// Действие, произошедшее с сущностью.
        /// </summary>
        ...
        /// <summary>
        /// Сериализованные в Json свойства изменившейся сущности.
        /// </summary>
        ...
        /// <summary>
        /// Сериализованные в Json дополнительные данные уведомления.
        /// </summary>
    ...
    /// <summary>
    /// Тип операции, которая было произведена над сущностью.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public partial class Equipment
    {
        ...
        /// <summary>
        /// Id результатов поверки, чтобы найти их во внешней системе.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calibrationResultId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CalibrationResultId { get; set; }

        /// <summary>
        /// Организация-поверитель.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calibrationOrganization", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CalibrationOrganization { get; set; }

        /// <summary>
        /// Результат поверки (пригоден - 1, непригоден - 0).
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calibrationResult", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? CalibrationResult { get; set; }

        /// <summary>
        /// Дата последней синхронизации данных о поверке.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("calibrationSyncDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? CalibrationSyncDate { get; set; }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("secondLevelPassword", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// Параметры опроса для оборудования с цифровым интерфейсом.
        /// </summary>
        ...
        /// <summary>
        /// Последние считанные с устройства параметры.
        /// </summary>
        ...
        /// <summary>
        /// Указывает что оборудование может быть установлено на нескольких объектах учёта.
        /// </summary>
        ...
        /// <summary>
        /// Подразделение, в который входит оборудование.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("divisionId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? DivisionId { get; set; }
    ...
    /// <summary>
    /// Интерфейс обмена данными с оборудованием.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class EquipmentDataInterface
    {
        ...
        /// <summary>
        /// Строка инициализации порта при прямом подключении к устройству.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("portSettings", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// Вид управления потоком при обмене данными через последовательный порт.
        /// </summary>
        ...
        /// <summary>
        /// Регулярное выражение, используемое для контроля пользовательского ввода пароля.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("passwordRegEx", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string PasswordRegEx { get; set; }

        /// <summary>
        /// Комментарий к паролю.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("passwordComment", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string PasswordComment { get; set; }

        /// <summary>
        /// Комментарий к паролю.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("secondLevelPasswordComment", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SecondLevelPasswordComment { get; set; }

        /// <summary>
        /// Максимальное количество устройств в одной сети. 0 - не ограничено.
        /// </summary>
        ...
        /// <summary>
        /// Сетевой адрес по умолчанию.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("networkAddressDefault", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string NetworkAddressDefault { get; set; }

        /// <summary>
        /// Условие использования сетевого адреса устройства.
        /// </summary>
        ...
        /// <summary>
        /// Комментарий по формату сетевого адреса.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("networkAddressComment", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string NetworkAddressComment { get; set; }

        /// <summary>
        /// Регулярное выражение, используемое для контроля пользовательского ввода сетевого адреса.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("networkAddressRegEx", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string NetworkAddressRegEx { get; set; }

        /// <summary>
        /// Минимальное значение сетевого адреса, если он задается в виде целого числа.
        /// </summary>
        ...
        /// <summary>
        /// Максимальное значение сетевого адреса, если он задается в виде целого числа.
        /// </summary>
        ...
        /// <summary>
        /// Интерфейс драйвера, если поддерживается.
        /// </summary>
        ...
        /// <summary>
        /// Определяет поддерживаемые биты четности обмена через COM-порт.
        /// </summary>
        ...
        /// <summary>
        /// Определяет количество стоп-битов при обмене через COM-порт.
        /// </summary>
    ...
    /// <summary>
    /// Интерфейс драйвера для оборудования.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class EquipmentDriverInterface
    {
        ...
        /// <summary>
        /// Наименование драйвера для этого оборудования.
        /// </summary>
        ...
        /// <summary>
        /// Количество каналов устройства в каждом тепловом вводе.
        /// </summary>
        ...
        /// <summary>
        /// Минимальный адрес памяти устройства.
        /// </summary>
        ...
        /// <summary>
        /// Максимальный адрес памяти устройства.
        /// </summary>
        ...
        /// <summary>
        /// Пороговая величина, после которой наступает сброс значения интегратора массы.
        /// </summary>
        ...
        /// <summary>
        /// Пороговая величина, после которой наступает сброс значения интегратора тепла.
        /// </summary>
        ...
        /// <summary>
        /// Список всех ячеек в данной модели устройства.
        /// </summary>
        ...
        /// <summary>
        /// Список адаптеров, поддерживаемых устройством.
        /// </summary>
        ...
        /// <summary>
        /// Список протоколов, поддерживаемых устройством.
        /// </summary>
        ...
        /// <summary>
        /// Список параметров БД устройства.
        /// </summary>
    ...
    public partial class EquipmentModel
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("serialNumberFormat", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SerialNumberFormat { get; set; }

        /// <summary>
        /// Комментарий
        /// </summary>
        [Newtonsoft.Json.JsonProperty("serialNumberComment", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SerialNumberComment { get; set; }

        /// <summary>
        /// Номер в государственном реестре средств измерений.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("stateRegisterNumber", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string StateRegisterNumber { get; set; }

        /// <summary>
        /// Наименование типа СИ в государственном реестре.
        /// <br/>По этому наименованию и серийному номеру устройство должно быть уникально идентифицировано в информационной системе с данными о поверках.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("stateRegisterTypeTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("isPressureDropSensor", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// Трансформатор тока.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("isCurrentTransformer", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool IsCurrentTransformer { get; set; }

        /// <summary>
        /// Трансформатор напряжения.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("isVoltageTransformer", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class EquipmentModelModification
    {
        ...
        /// Класс точности.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("precisionClass", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("nominalStaticCharacteristic", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string NominalStaticCharacteristic { get; set; }

        /// <summary>
        /// Коэффициент трансформации.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("transformationRatio", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public float TransformationRatio { get; set; }

        /// <summary>
        /// Нижняя граница пределов измерения датчика перепада давления.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pressDropSensorMin", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public float PressDropSensorMin { get; set; }

        /// <summary>
        /// Верхняя граница пределов измерения датчика перепада давления.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pressDropSensorMax", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public float PressDropSensorMax { get; set; }

    }

    /// <summary>
    /// Описание порта коммуникационного контроллера.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Описание настроек порта коммуникационного контроллера.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public partial class EquipmentModem
    {
        ...
        /// <summary>
        /// Порт опроса для GPRS-модемов без идентификации.
        /// </summary>
        ...
        /// <summary>
        /// Признак того, что коммуникационное оборудование сейчас на связи.
        /// </summary>
        ...
        /// <summary>
        /// Указывает что модему требуется отправлять пакеты "KeepAlive".
        /// </summary>
    ...
    public partial class EquipmentReadParameters
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hardwareVersion", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("batteryLow", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// <summary>
    /// Идентификаторы общих для всех устройств настроечных параметров
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Стандартные типы событий устройства.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum GeneralEventType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"ClockCorrection")]
        ClockCorrection = 8,
    ...
    /// <summary>
    /// Параметры ответа на запрос на получение списка оборудования (GetEquipmentList).
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GetEquipmentListResponseParameters
    {
        ...
        /// <summary>
        /// Список всех моделей оборудования.
        /// </summary>
        ...
        /// <summary>
        /// Связь оборудования с объектами учета.
        /// </summary>
    ...
    /// <summary>
    /// Параметры ответа на запрос получения экземпляра оборудования.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GetEquipmentResponseParameters
    {
        ...
        /// <summary>
        /// Точки учета, связанные с этим устройством через привязку каналов, ячеек или адресов.
        /// </summary>
        ...
        /// <summary>
        /// Объекты учета, на которых установлено это оборудование.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("nodes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Node> Nodes { get; set; }

        /// <summary>
        /// Список привязки адресов универсального modbus устройства.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("modbusBindings", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<UniversalModbusBinding> ModbusBindings { get; set; }

    }

    /// <summary>
    /// Действие для операции получения мнемосхемы.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Ответ на запрос размера изображения мнемосхемы.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Ответ на запрос изображения мнемосхемы.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Ответ на запрос получения объектов мнемосхемы.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GetMapObjectsResponseParameters
    {
        /// <summary>
        /// Наименование мнемосхемы.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("title", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Title { get; set; }

        /// <summary>
        /// Указывает что мнемосхема общедоступная.
        /// </summary>
        ...
        /// <summary>
        /// Список всех используемых на мнемосхемах изображений.
        /// </summary>
        ...
        /// <summary>
        /// Список оформлений объектов на карте.
        /// </summary>
    ...
    /// <summary>
    /// Параметры запроса на получение мнемосхемы.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Ответ на получение записей с потреблением
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GetMeasurePointConsumptionResponse
    {
        ...
        /// <summary>
        /// Записи с месячным потреблением.
        /// </summary>
        ...
        /// <summary>
        /// Записи с суточным потреблением.
        /// </summary>
        ...
        /// <summary>
        /// Единицы измерения для категории параметров.
        /// </summary>
        ...
        public ConsumptionSummaryResponse Summary { get; set; }

    }

    /// <summary>
    /// Параметры ответа на запрос списка точек учета.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GetMeasurePointListResponseParameters
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lastConsumption", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<MeasurePointLastConsumptionParameters> LastConsumption { get; set; }

        /// <summary>
        /// Список оборудования на точках учета.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipment", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// <summary>
    /// Ответ на запрос информации по конкретной точке учета.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GetMeasurePointResponseParameters
    {
        ...
        /// <summary>
        /// Параметры диагностики на нештатные ситуации для зимнего режима.
        /// </summary>
        ...
        /// <summary>
        /// Параметры диагностики на нештатные ситуации для летнего режима.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("userDiagParams", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<UserDiagParam> UserDiagParams { get; set; }

        /// <summary>
        /// Таблица с заданиями на опрос, через которые опрашивается точка учета.
        /// </summary>
        ...
        /// <summary>
        /// Список имеющихся отчетных форм, которые можно назначать точкам учета (Ведомость параметров и Акты).
        /// </summary>
        ...
        /// <summary>
        /// Отчетные формы, назначенные точке учета.
        /// </summary>
        ...
        /// <summary>
        /// Список имеющихся отчетов, для которых отчетные формы назначаются в свойствах точки учета.
        /// </summary>
        ...
        /// <summary>
        /// Давление в подающей магистрали по умолчанию (избыточное), ат.
        /// </summary>
        ...
        /// <summary>
        /// Давление в обратной магистрали по умолчанию (избыточное), ат.
        /// </summary>
        ...
        /// <summary>
        /// Выражения для расчетной точки учета.
        /// </summary>
    ...
    /// <summary>
    /// Ответ на получение записей с показаниями
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Параметры ответа на запрос получения списка объектов учета.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GetNodeListResponseParameters
    {
        ...
        /// <summary>
        /// Список обслуживающих инженеров.
        /// </summary>
        ...
        public System.Collections.Generic.ICollection<Serviceman> Servicemen { get; set; }

        /// <summary>
        /// Массив обслуживающих организаций.
        /// </summary>
    ...
    /// <summary>
    /// Запись со статистикой по GPRS-контроллеру.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GprsControllerStatisticsObject
    {
        ...
        /// <summary>
        /// Кол-во сеансов в прошлом месяце.
        /// </summary>
    ...
    /// <summary>
    /// Сеанс соединения GPRS-контроллера с системой.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class GprsModemSession
    {
        /// <summary>
        /// Уникальный в рамках системы идентификатор сеанса.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int Id { get; set; }

        /// <summary>
        /// Идентификатор контроллера, которому принадлежит сеанс.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("controllerId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int ControllerId { get; set; }
        ...
        /// <summary>
        /// Дата и время по часам контроллера на момент подключения.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает IP-адрес контроллера.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает номер TCP-порта контроллера.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает текущий баланс SIM-карты.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает ICCID (Integrated Circuit Card Identifier).
        /// </summary>
        ...
        /// <summary>
        /// Возвращает номер активной SIM-карты.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает значение, определяющее, включена ли в SIM-карте защита PIN-кодом.
        /// </summary>
        ...
        /// <summary>
        /// Код завершения сеанса связи с GPRS-модемом.
        /// </summary>
    ...
    public partial class HeatLoss
    {
        ...
        /// <summary>
        /// Возвращает теплопотери на январь.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на февраль.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на март.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на апрель.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на июнь.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на июль.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на август.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на сентябрь.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на октябрь.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на ноябрь.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает теплопотери на декабрь.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает процент тепловых потерь от фактического теплопотребления.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает нормативные часовые теплоптери (ГКал/час)
        /// </summary>
    ...
    /// <summary>
    /// Нормативы на потребление для жилого дома.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class HouseNorms
    {
        /// <summary>
        /// Норматив на потребление холодной воды на человека в месяц (м3)
        /// </summary>
        ...
        /// <summary>
        /// Норматив на потребление горячей воды на человека в месяц (м3)
        /// </summary>
        ...
        /// <summary>
        /// Норматив потребления тепла на квадратный метр в месяц (ГКал).
        /// </summary>
        ...
        /// <summary>
        /// Норматив потребления электроэнергии на человека в месяц (кВт*ч).
        /// </summary>
        ...
        /// <summary>
        /// Норматив потребления газа на человека в месяц (м3).
        /// </summary>
    ...
    public partial class Incident
    {
        ...
        /// <summary>
        /// Идентификатор объекта учета, связанного с нештатной ситуацией
        /// </summary>
        [Newtonsoft.Json.JsonProperty("nodeId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int NodeId { get; set; }

        /// <summary>
        /// Идентификатор точки учета, связанной с нештатной ситуацией
        /// </summary>
        [Newtonsoft.Json.JsonProperty("measurePointId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? MeasurePointId { get; set; }

        /// <summary>
        /// Идентификатор оборудования, связанного с нештатной ситуацией.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipmentId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? EquipmentId { get; set; }
        ...
        /// <summary>
        /// Наименование точки / объекта
        /// </summary>
        [Newtonsoft.Json.JsonProperty("entityTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string EntityTitle { get; set; }

        /// <summary>
        /// Адрес объекта учёта, по которому произошла НС
        /// </summary>
    ...
    /// <summary>
    /// Параметры ответа на получение нештатной ситуации.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public partial class IncidentLog
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shortMessage", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class LicenseInformation
    {
        ...
        /// <summary>
        /// Количество лицензий на объекты учета.
        /// </summary>
        ...
        /// <summary>
        /// Количество лицензий на поквартирный опрос.
        /// </summary>
        ...
        /// <summary>
        /// Срок действия лицензии. Если имеет значение DateTime.MinValue, то лицензия бессрочная.
        /// </summary>
        ...
        /// <summary>
        /// Используется лицензий на поквартирный опрос.
        /// </summary>
    ...
    /// <summary>
    /// Дополнительная информация приходящая в ответе на логин.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class LoginExtraInfo
    {
        ...
        /// <summary>
        /// Разница между временем в местном часовом поясе сервера и временем в формате UTC (в часах).
        /// </summary>
        ...
        /// <summary>
        /// Системные параметры интерфейса пользователя.
        /// </summary>
    ...
    /// <summary>
    /// Ответ на запрос авторизации через WEB API.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class LoginResponseParameters
    {
        /// <summary>
        /// Токен для выполнения запросов.
        /// </summary>
    ...
    /// <summary>
    /// Ответ на запрос запуска ручного опроса.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class ManualPollResponseParameters_v1
    {
        /// <summary>
        /// Идентификатор запущенного сеанса опроса.
        /// </summary>
    ...
    /// <summary>
    /// Представляет объект мнемосхемы.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class MapObject
    {
        ...
        /// <summary>
        /// Идентификатор мнемосхемы, которой принадлежит данный объект.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("mapId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int MapId { get; set; }
        ...
        /// <summary>
        /// Идентификатор точки учета, с которой связан данный объект.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("measurePointId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int MeasurePointId { get; set; }
        ...
        /// <summary>
        /// Измеряемый параметр на точке учета.
        /// </summary>
        ...
        /// <summary>
        /// Объект заблокирован от перемещения и изменения размера.
        /// </summary>
        ...
        /// <summary>
        /// Порядок наложения объекта по оси Z (Z-order).
        /// </summary>
        ...
        /// <summary>
        /// Привязка к сигнализации на объекте учета.
        /// </summary>
    ...
    /// <summary>
    /// Оформление объекта мнемосхемы.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class MapObjectAppearance
    {
        /// <summary>
        /// Идентификатор объекта мнемосхемы, которому принадлежит оформление.
        /// </summary>
        ...
        /// <summary>
        /// Тип оформления (для какого случая оно используется).
        /// </summary>
        [Newtonsoft.Json.JsonProperty("type", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        ...
        /// <summary>
        /// Видимость объекта на мнемосхеме.
        /// </summary>
    ...
    /// <summary>
    /// Тип оформления объекта мнемосхемы.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Описывает объект системы "Точка учета".
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class MeasurePoint
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fullTitle", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        ...
        /// <summary>
        /// Адрес Объекта учета либо Лицевого счета.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("address", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Address { get; set; }
        ...
        /// <summary>
        /// Порядковый номер в инженерной системе.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор Помещения. Имеет значение только для коммунальных точек учета.
        /// </summary>
        ...
        /// <summary>
        /// Список измеряемых параметров, отображаемых по умолчанию в таблицах и графиках.
        /// </summary>
        ...
        /// <summary>
        /// Отображать рассчитанные данные.
        /// </summary>
        ...
        /// <summary>
        /// Отображать недостоверные значения.
        /// </summary>
        ...
        /// <summary>
        /// Пользовательские атрибуты точки учета.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("attributes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<MeasurePointCustomAttribute> Attributes { get; set; }

        /// <summary>
        /// Устройство, используемое для опроса точки учета.
        /// </summary>
        ...
        /// <summary>
        /// Модель оборудования устройства опроса.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор статуса обслуживания точки учёта.
        /// </summary>
    ...
    /// <summary>
    /// Класс параметров расчета и хранения.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class MeasurePointCalcAndStorageObject
    {
        ...
        /// <summary>
        /// Режим расчета недостающих записей с потреблением.
        /// </summary>
        ...
        /// <summary>
        /// Тип отображаемого давления по точке учёта.
        /// </summary>
        ...
        /// <summary>
        /// Срок годности последних данных (в минутах).
        /// </summary>
        [Newtonsoft.Json.JsonProperty("lastDataShelfLife", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Range(1, 50000)]
        public int? LastDataShelfLife { get; set; }
    ...
    public partial class MeasurePointDataConsumptionRecord
    {
        ...
        /// <summary>
        /// Возвращает значение, определяющее, является ли запись пустой (отсутствующей).
        /// </summary>
        ...
        /// <summary>
        /// Дата и время данных потребления.
        /// </summary>
    ...
    public partial class MeasurePointDataCopySettings
    {
        ...
        /// <summary>
        /// Идентификатор исходной точки учёта.
        /// </summary>
    ...
    /// <summary>
    /// Запись с данными об показаниях интеграторов.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Типы единиц измерения в которых можно запросить данные по точке учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Запись архива ошибок по точке учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class MeasurePointDeviceErrorRecord
    {
        ...
        /// <summary>
        /// Стандартный тип события устройства.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("generalEventType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        ...
        [Newtonsoft.Json.JsonProperty("importance", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public DeviceEventImportance Importance { get; set; }

    }

    /// <summary>
    /// Ответ на запрос архива ошибок устройства по точке учета.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Содержит последние данные по точке учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Параметры последнего потребления по точке учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class MeasurePointLastConsumptionParameters
    {
        ...
        /// <summary>
        /// Дата и время получения последнего потребления.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dateTime", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset DateTime { get; set; }
    ...
    /// <summary>
    /// Содержит последние интеграторы по точке учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Структура хранения списка назначенных отчетных форм
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class MeasurePointReport
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reportTemplateTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// <summary>
    /// Тип данных Modbus регистра.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum ModbusRegisterType
    {

        [System.Runtime.Serialization.EnumMember(Value = @"Holding")]
        Holding = 0,
    ...
    public enum ModemModel
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"UsrTcp232410S")]
        UsrTcp232410S = 47,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"Am02")]
        Am02 = 57,

        [System.Runtime.Serialization.EnumMember(Value = @"Rx600R2")]
        Rx600R2 = 58,

        [System.Runtime.Serialization.EnumMember(Value = @"IrzAtm31")]
        IrzAtm31 = 59,
    ...
    /// <summary>
    /// Параметры уведомления о подключении/отключении модема.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class ModemOnlineNotifyParameters
    {
        /// <summary>
        /// Идентификатор устройства.
        /// </summary>
        ...
        /// <summary>
        /// Признак того, что модем в сети.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("isOnline", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool IsOnline { get; set; }

        /// <summary>
        /// Параметры последнего сеанса связи.
        /// </summary>
        ...
        public GprsModemSession LastSession { get; set; }

        /// <summary>
        /// Статистика по модему.
        /// </summary>
    ...
    /// <summary>
    /// Описывает объект системы "Объект учета".
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class Node
    {
        ...
        /// <summary>
        /// Подразделение, в которое входит объект учёта.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("divisionId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? DivisionId { get; set; }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("responsiblePhone", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ResponsiblePhone { get; set; }

        /// <summary>
        /// Идентификатор обслуживающего инженера.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор территории, на которой находится объект учёта
        /// </summary>
        ...
        /// <summary>
        /// Количество используемых в объекте учета лицензий.
        /// </summary>
        ...
        /// <summary>
        /// Определяет, включен ли отопительный сезон на этом объекте учета.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("isHeatingSeason", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool IsHeatingSeason { get; set; }
        ...
        /// <summary>
        /// Нормативы потребления для жилого дома.
        /// </summary>
        ...
        /// <summary>
        /// Пользовательские атрибуты объекта учета.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("attributes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<NodeCustomAttribute> Attributes { get; set; }

        /// <summary>
        /// Источники энергоснабжения для объекта.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("powerSources", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<NodePowerSource> PowerSources { get; set; }
    ...
    /// <summary>
    /// Представляет сущность "Группа объектов учета".
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class NodeGroup
    {
        ...
        /// <summary>
        /// Идентификатор домена, в который входит группа.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("divisionId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? DivisionId { get; set; }
    ...
    /// <summary>
    /// Группа объектов учёта с членами.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class NodeGroupWithMembers
    {
        /// <summary>
        /// Параметры группы объектов.
        /// </summary>
        ...
        /// <summary>
        /// Идентификаторы объектов учёта, входящих в группу.
        /// </summary>
    ...
    /// <summary>
    /// Описывает работу на объекте учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class NodeJobDTO
    {
        /// <summary>
        /// ID работы.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("creatorAccount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public PublicAccount CreatorAccount { get; set; }

        /// <summary>
        /// ID учетной записи исполнителя работы.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("performerAccount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public PublicAccount PerformerAccount { get; set; }
        ...
        /// Исполнитель работы.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("performerName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// Нештатная ситуация, по которой была создана работа.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("incident", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public Incident Incident { get; set; }
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class NodePowerSource
    {
        /// <summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("sourceNodeId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int SourceNodeId { get; set; }

    }

    /// <summary>
    /// Параметры сигнализации для объекта учета.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class NodeSignaling
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("signalTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SignalTitle { get; set; }

        /// <summary>
        /// Идентификатор контроллера, с которого считывается сигнал.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipmentId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int EquipmentId { get; set; }

        /// <summary>
        /// Номер сухого контакта в контроллере.
        /// </summary>
        ...
        /// <summary>
        /// Текст сообщения в нештатной ситуации, которая будет создана при установке сигнала.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("incidentMessageSet", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// Текст сообщения в нештатной ситуации, которая будет создана при сбросе сигнала.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("incidentMessageUnset", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string IncidentMessageUnset { get; set; }

        /// <summary>
        /// Состояние сигнала объекта учета.
        /// </summary>
    ...
    /// <summary>
    /// Ресурсоснабжающая организация (РСО) для объекта учета.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class NodeSupplier
    {
        ...
        /// <summary>
        /// Идентификатор ресурсоснабжающей организации.
        /// </summary>
        ...
        /// <summary>
        /// Номер договора на поставку ресурса.
        /// </summary>
    ...
    public enum NodeType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"PowerSource")]
        PowerSource = 3,

    }

    /// <summary>
    /// Параметры уведомления для какой-либо сущности.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class NotificationParameters
    {
        ...
        /// <summary>
        /// Данные, сериализованные в Json.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("jsonData", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    ...
    /// <summary>
    /// Модель, хранящая свойства подключения для опроса оборудования.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class PollConnection
    {
        ...
        /// Номер телефона.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dialNumber", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// Модель коммуникационного оборудования.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор группы портов опроса.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pollPortGroupTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string PollPortGroupTitle { get; set; }

        /// <summary>
        /// Возвращает признак того, что подключение принадлежит сети устройств (только для чтения).
        /// </summary>
        ...
        /// <summary>
        /// Хост для Интернет-подключения.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("internetHost", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>
        /// Оборудование, связанное с подключением.
        /// </summary>
    ...
    /// <summary>
    /// Описывает объект системы "Порт опроса".
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class PollPort
    {
        ...
        /// <summary>
        /// Идентификатор службы опроса, к которой относится порт.
        /// </summary>
        ...
        /// <summary>
        /// Имя COM-порта, которое используется для подключения.
        /// </summary>
        ...
        /// <summary>
        /// Признак того, что порт разрешен к использованию.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("enabled", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool Enabled { get; set; }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dialPrefix", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string DialPrefix { get; set; }

        /// <summary>
        /// IP-адрес, на котором Служба опроса должна принимать подключения от GPRS-модемов.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("gprsListenIpAddress", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string GprsListenIpAddress { get; set; }

        /// <summary>
        /// Номер TCP-порта, на котором Служба опроса должна принимать подключения от GPRS-модемов.
        /// </summary>
        ...
        /// <summary>
        /// Максимальное количество подключений, обрабатываемых портом опроса (для портов опроса с каналом связи Интернет или GPRS).
        /// </summary>
        ...
        /// <summary>
        /// Использовать программный контроль установки/разрыва связи модемом.
        /// </summary>
        ...
        /// <summary>
        /// Количество минут, включённых в тарифный план.
        /// </summary>
        ...
        /// <summary>
        /// Дата, до которой заблокирован порт.
        /// </summary>
        ...
        /// <summary>
        /// Блокировать порт после истечения количества минут в тарифе.
        /// </summary>
    ...
    /// <summary>
    /// Класс слоя доступа к данным задания на опрос.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class PollTask
    {
        ...
        /// <summary>
        /// Количество совершенных попыток выполнить задание.
        /// </summary>
        ...
        /// <summary>
        /// Начало текущей попытки - если задание выполняется, начало периода, в течение которого разрешено выполнение попыток - если не выполняется.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("startDate", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset StartDate { get; set; }

        /// <summary>
        /// Время окончания периода, в течение которого разрешено выполнение задания.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("endDate", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset EndDate { get; set; }
        ...
        /// <summary>
        /// Код результата последней попытки выполнения задания.
        /// </summary>
        ...
        /// <summary>
        /// Максимальное количество попыток повторного опроса в случае ошибки.
        /// <br/>Для GPRS - максимальное количество сеансов в сутки.
        /// </summary>
        ...
        /// <summary>
        /// Таймаут до выполнения следующей попытки в случае сбоя опроса (в секундах).
        /// </summary>
        ...
        /// <summary>
        /// Флаг работы в режиме удалённого пульта.
        /// </summary>
        ...
        /// <summary>
        /// Интервал опроса текущих данных.
        /// </summary>
        ...
        /// <summary>
        /// Указывает на то, что при опросе должны быть загружены только отсутствующие данные за указанный период.
        /// </summary>
        ...
        /// <summary>
        /// Дата начала интервала считываемых данных.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pollIntervalStartDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? PollIntervalStartDate { get; set; }

        /// <summary>
        /// Дата окончания интервала считываемых данных.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("pollIntervalEndDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? PollIntervalEndDate { get; set; }

    }

    /// <summary>
    /// Параметры автоопроса точки учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class PollTaskMeasurePoint
    {
        ...
        /// <summary>
        /// Флаг выполнять или нет коррекцию времени.
        /// </summary>
        ...
        /// <summary>
        /// Дата постановки точки учёта на автоопрос.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("autoPollStartDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? AutoPollStartDate { get; set; }

        /// <summary>
        /// Признак подключения по умолчанию.
        /// </summary>
        ...
        /// <summary>
        /// Опрашивать только если задание по умолчанию завершилось с ошибкой.
        /// </summary>
        ...
        /// <summary>
        /// Указывает, что для точки учёта нужно выполнять непрерывный опрос текущих.
        /// </summary>
    ...
    /// <summary>
    /// Учетная запись с ограниченной информацией.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Тип данных хранящихся в регистре.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum RegisterDataType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"UInt24")]
        UInt24 = 1,

        [System.Runtime.Serialization.EnumMember(Value = @"UInt32")]
        UInt32 = 2,

        [System.Runtime.Serialization.EnumMember(Value = @"UInt48")]
        UInt48 = 3,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"Int24")]
        Int24 = 6,

        [System.Runtime.Serialization.EnumMember(Value = @"Int32")]
        Int32 = 7,

        [System.Runtime.Serialization.EnumMember(Value = @"Int48")]
        Int48 = 8,
    ...
    public partial class Report
    {
        ...
        /// <summary>
        /// Тип объектов, используемый в отчетных формах.
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fileNameFormat", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class ReportParameter
    {
        ...
        /// <summary>
        /// Идентификатор свойств пользовательского параметра Lers.Models.ReportParameterProperty.
        /// </summary>
    ...
    public enum ReportPrintCenterMode
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"ViewRequiresApprovalReports")]
        ViewRequiresApprovalReports = 2,
    ...
    public partial class ReportTemplate
    {
        ...
        /// <summary>
        /// Вариант выбора единиц измерения при формировании отчета.
        /// </summary>
    ...
    public enum ReportType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"SummaryWorkOrder")]
        SummaryWorkOrder = 33,
    ...
    /// <summary>
    /// Базовые параметры ответа на запрос.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class ResponseParameters
    {
        ...
        /// <summary>
        /// Дополнительные данные, связанные с исключением.
        /// </summary>
    ...
    /// <summary>
    /// Параметры сохранения потребления.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Параметры запроса сохранения потребления по точке учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class SaveConsumptionRequestParameters
    {
        ...
        /// <summary>
        /// Единицы измерения, в которых передаются величины для сохранения (необязательный параметр).
        /// </summary>
    ...
    /// <summary>
    /// Параметры запроса на сохранение данных по точке учета.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    /// <summary>
    /// Параметры запроса сохранения интеграторов по точке учёта.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class SaveTotalsRequestParameters
    {
        /// <summary>
        /// Список данных интеграторов для сохранения.
        /// </summary>
    ...
    {
        /// <summary>
        /// Флаг разрешенности выполнять задание.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("enabled", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool Enabled { get; set; }
    ...
    /// <summary>
    /// Сезоны работы систем теплоснабжения и ГВС.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum Season
    {
    ...
    public partial class Sensor
    {
        ...
        /// <summary>
        /// Ссылка на экземпляр оборудования.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("equipment", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public Equipment Equipment { get; set; }
    ...
    {
        /// <summary>
        /// Тип сервера (ЛЭРС УЧЁТ).
        /// </summary>
        [Newtonsoft.Json.JsonProperty("type", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Type { get; set; }

        /// <summary>
        /// Номер сборки системы ЛЭРС УЧЕТ.
        /// </summary>
        ...
        /// <summary>
        /// Информация об операционной системе, на которой запущен сервер.
        /// </summary>
    ...
    public partial class ServiceCompany
    {
        ...
        /// <summary>
        /// Список учётных записей обслуживающих, относящихся к данной организации.
        /// </summary>
    ...
    public partial class Supplier
    {
        ...
        /// <summary>
        /// Контактная информация для связи с ресурсоснабжающей организацией.
        /// </summary>
    ...
    /// <summary>
    /// Системные параметры, связанные с настройкой интерфейса пользователя.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class SystemParametersGui
    {
        ...
        /// <summary>
        /// Указывает что требуется включить поквартирный учёт.
        /// </summary>
        ...
        /// <summary>
        /// Указывает что разрешены праздничные темы оформления.
        /// </summary>
        ...
        /// <summary>
        /// Указывает, что пользователю разрешено сохранять индивидуальные настройки колонок в таблице с данными.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("enableDataTableUserSetting", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool EnableDataTableUserSetting { get; set; }

        /// <summary>
        /// Наименование веб-сайта.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("siteTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SiteTitle { get; set; }

        /// <summary>
        /// Описатель веб-сайта.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("siteDescription", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SiteDescription { get; set; }

        /// <summary>
        /// Адрес логотипа сайта.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("logoFileName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string LogoFileName { get; set; }

        /// <summary>
        /// Адрес логотипа страницы входа.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("loginLogoFileName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string LoginLogoFileName { get; set; }

        /// <summary>
        /// Контакты администратора (Email, телефон или иной вид связи с администратором).
        /// </summary>
        [Newtonsoft.Json.JsonProperty("adminContacts", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// <summary>
    /// Код завершения обработки задания
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public partial class Territory
    {
        ...
        /// <summary>
        /// Идентификатор родительской территории.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("parentId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? ParentId { get; set; }
        ...
        /// <summary>
        /// Идентификатор точки учёта, из которой копируется Тнв для территории.
        /// </summary>
        ...
        /// <summary>
        /// Массив значения нормативных температур наружного воздуха
        /// <br/>MonthStdTemperature[0] - Январь
        /// <br/>MonthStdTemperature[1] - Февраль
        /// <br/>. . . 
        /// <br/>MonthStdTemperature[11] - Декабрь
        /// </summary>
    ...
    /// <summary>
    /// Запись от температуре наружного воздуха для территории на указанную дату.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class TerritoryOutdoorTemperature
    {
        /// <summary>
        /// Дата, на которую зафиксирована температура.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("date", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset Date { get; set; }
    ...
    {
        /// <summary>
        /// Разница между временем в этом часовом поясе и временем в формате UTC (в часах).
        /// </summary>
    ...
    /// <summary>
    /// Атрибуты записи с интеграторами.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    ...
    public enum Unit
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"KilogramPerCubicMeter")]
        KilogramPerCubicMeter = 49,
    ...
    /// <summary>
    /// Привязка измеряемого параметра в универсальном Modbus устройстве.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class UniversalModbusBinding
    {
        /// <summary>
        /// Идентификатор точки учета.
        /// </summary>
        ...
        /// Тип данных хранящихся в регистре.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("registerDataType", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        ...
        /// Порядок следования байт данных.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("dataByteOrder", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public DataByteOrder DataByteOrder { get; set; }
    ...
    public partial class UserDiagParam
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("shortMessage", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.StringLength(100)]
        public string ShortMessage { get; set; }
    ...
    /// <summary>
    /// Параметры экспорта данных в формат Xml80020.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class Xml80020ExportOptions
    {
        ...
        /// <summary>
        /// Кол-во знаков после запятой, для значений профиля мощности.
        /// </summary>
        ...
        /// <summary>
        /// Код атрибута, где хранятся ИНН.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("vatAttributeCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string VatAttributeCode { get; set; }

        /// <summary>
        /// Отмечает необходимость создания папки для каждого месяца.
        /// </summary>
    ...
    public partial class MeasuredParameterUnitCollection
    {
        ...
        [Newtonsoft.Json.JsonProperty("CalorificValue", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public Unit CalorificValue { get; set; }
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public Unit Humidity { get; set; }

        [Newtonsoft.Json.JsonProperty("CarbonDioxideContent", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public Unit CarbonDioxideContent { get; set; }

        [Newtonsoft.Json.JsonProperty("NitrogenContent", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public Unit NitrogenContent { get; set; }
